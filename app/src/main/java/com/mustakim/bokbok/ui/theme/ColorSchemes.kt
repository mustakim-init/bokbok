...
fun getDarkColorScheme(theme: AppTheme): ColorScheme = when (theme) {
    AppTheme.CATPPUCCIN -> darkColorScheme(
        ...
        surfaceContainerLowest = Color(0xFF1E1E2E),
        surfaceContainerHigh = Color(0xFF35354A),
        surfaceContainerHighest = Color(0xFF3F3F55),
...
fun getLightColorScheme(theme: AppTheme): ColorScheme = when (theme) {
    AppTheme.GRUVBOX -> lightColorScheme(
        ...
        onPrimary = Color.White,
        primaryContainer = Color(0xFFF5D9B8), // 87% lightness
        onPrimaryContainer = Color(0xFF5F2100),
        secondary = GruvboxSecondaryLight,
        onSecondary = Color.White,
        secondaryContainer = Color(0xFFEEF2C7), // 87% lightness
        onSecondaryContainer = Color(0xFF3D4700),
        tertiary = GruvboxTertiaryLight,
        onTertiary = Color.White,
        tertiaryContainer = Color(0xFFFCDAD7), // 90% lightness for error tones
        ...
        surfaceContainerLow = Color(0xFFFDFBE9),
    ...
    AppTheme.CATPPUCCIN -> lightColorScheme(
        ...
        onPrimary = Color.White,
        primaryContainer = Color(0xFFF0E5FF), // 90% lightness
        onPrimaryContainer = Color(0xFF5C0099),
        secondary = CatppuccinSecondaryLight,
        onSecondary = Color.White,
        secondaryContainer = Color(0xFFFCEAF6), // 90% lightness
        onSecondaryContainer = Color(0xFF8B005D),
        tertiary = CatppuccinTertiaryLight,
        onTertiary = Color.White,
        tertiaryContainer = Color(0xFFE6F2FF), // 90% lightness
