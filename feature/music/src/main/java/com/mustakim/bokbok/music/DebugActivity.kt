        ...
        setContent {
            BokBokTheme {
                CrashReportScreen(
                    ...
                    onRestart = {
                        runCatching {
                            val intent = Intent(this, Class.forName("com.mustakim.bokbok.MainActivity")).apply {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    BokBokIconButton(onClick = onCopyAll) {
                        Icon(
                            painter = painterResource(CoreR.drawable.select_all),
                            contentDescription = null,
                        )
                    }
                    BokBokIconButton(onClick = onShareAll) {
                        Icon(
                            painter = painterResource(CoreR.drawable.share),
                            contentDescription = null,
                        )
                    }
                    BokBokIconButton(onClick = onClose) {
                        Icon(
...
private fun buildCrashReport(
    ...
    val header = buildString {
        appendLine("BokBok crash report")
