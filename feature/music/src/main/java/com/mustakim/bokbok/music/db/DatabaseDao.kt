package com.mustakim.bokbok.music.db
...
import com.mustakim.bokbok.music.db.entities.AlbumArtistMap
import com.mustakim.bokbok.music.db.entities.AlbumEntity
import com.mustakim.bokbok.music.db.entities.PlayCountEntity
import com.mustakim.bokbok.music.db.entities.AlbumWithSongs
...
import com.mustakim.bokbok.music.db.entities.PlaylistPlayCount
...
import com.mustakim.bokbok.music.db.entities.SearchHistory
import com.mustakim.bokbok.music.db.entities.SetVideoIdEntity
import com.mustakim.bokbok.music.db.entities.Song
import com.mustakim.bokbok.music.db.entities.SongAlbumMap
...
import com.mustakim.bokbok.music.db.entities.TagEntity
import com.mustakim.bokbok.music.db.entities.PlaylistTagMap
import com.mustakim.bokbok.music.db.entities.*
import com.mustakim.bokbok.music.extensions.reversed
import com.mustakim.bokbok.music.extensions.toSQLiteQuery
import com.mustakim.bokbok.music.models.MediaMetadata
import com.mustakim.bokbok.music.models.toMediaMetadata
import com.mustakim.bokbok.music.ui.utils.*
...
interface DatabaseDao {
    ...
    @Transaction
    @SuppressWarnings("ROOM_CURSOR_MISMATCH")
    @Query(
        """
        SELECT artist.*,
               (SELECT COUNT(1)
    ...
    @Transaction
    @Query("SELECT * FROM song WHERE isLocal = 1 ORDER BY rowid DESC")
    fun localSongsByCreateDateAsc(): Flow<List<Song>>

    @Transaction
    @Query("SELECT * FROM song WHERE isLocal = 1 ORDER BY rowid DESC")
    fun localSongsPagingSource(): PagingSource<Int, Song>
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    fun insert(format: FormatEntity)
