...
data class MediaMetadata(
    ...
    fun toSongItem() = SongItem(
        id = id,
        title = title,
        artists = artists.map { com.mustakim.bokbok.music.innertube.models.Artist(name = it.name, id = it.id ?: "") },
        album = album?.let { com.mustakim.bokbok.music.innertube.models.Album(name = it.title, id = it.id) },
        duration = duration,
