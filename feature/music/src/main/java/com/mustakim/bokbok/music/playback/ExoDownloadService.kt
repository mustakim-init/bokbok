...
import com.mustakim.bokbok.music.R
    ...
    override fun getForegroundNotification(
        ...
        Notification.Builder.recoverBuilder(
            this, downloadUtil.downloadNotificationHelper.buildProgressNotification(
                ...
                else resources.getQuantityString(MusicR.plurals.n_song, downloads.size, downloads.size),
                downloads,
                notMetRequirements
            )
        ).addAction(
            Notification.Action.Builder(
                Icon.createWithResource(this, CoreR.drawable.close),
