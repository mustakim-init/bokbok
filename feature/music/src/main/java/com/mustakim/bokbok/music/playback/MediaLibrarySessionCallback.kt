...
import com.mustakim.bokbok.music.constants.MediaSessionConstants
                ...
                when (parentId) {
                    MusicService.ROOT ->
                        listOf(
                            browsableMediaItem(
                                MusicService.SONG,
                                context.getString(MusicR.string.songs),
                                null,
                                drawableUri(CoreR.drawable.music_note),
                                MediaMetadata.MEDIA_TYPE_PLAYLIST,
                            ),
                            browsableMediaItem(
                                MusicService.ARTIST,
                                context.getString(MusicR.string.artists),
                                null,
                                drawableUri(CoreR.drawable.artist),
                                MediaMetadata.MEDIA_TYPE_FOLDER_ARTISTS,
                            ),
                            browsableMediaItem(
                                MusicService.ALBUM,
                                context.getString(MusicR.string.albums),
                                null,
                                drawableUri(CoreR.drawable.album),
                                MediaMetadata.MEDIA_TYPE_FOLDER_ALBUMS,
                            ),
                            browsableMediaItem(
                                MusicService.PLAYLIST,
                                context.getString(MusicR.string.playlists),
                                null,
                                drawableUri(CoreR.drawable.queue_music),
                    ...
                    MusicService.PLAYLIST -> {
                        ...
                        listOf(
                            browsableMediaItem(
                                ...
                                context.getString(MusicR.string.liked_songs),
                                context.resources.getQuantityString(
                                    MusicR.plurals.n_song,
                                    likedSongCount,
                                    likedSongCount
                                ),
                                drawableUri(CoreR.drawable.favorite),
                                MediaMetadata.MEDIA_TYPE_PLAYLIST,
                            ),
                            browsableMediaItem(
                                "${MusicService.PLAYLIST}/${PlaylistEntity.DOWNLOADED_PLAYLIST_ID}",
                                context.getString(MusicR.string.downloaded_songs),
                                context.resources.getQuantityString(
                                    MusicR.plurals.n_song,
                                    downloadedSongCount,
                                    downloadedSongCount
                                ),
                                drawableUri(CoreR.drawable.download),
                                MediaMetadata.MEDIA_TYPE_PLAYLIST,
                            ),
                        ) +
