...
fun LazyGridScope.DownloadGridMenu(
    ...
    when (state) {
        Download.STATE_COMPLETED -> {
            GridMenuItem(
                icon = CoreR.drawable.offline,
                title = CoreR.string.remove_download,
        ...
        Download.STATE_QUEUED, Download.STATE_DOWNLOADING -> {
            GridMenuItem(
                ...
                title = MusicR.string.downloading,
                onClick = onRemoveDownload
            )
        }
            ...
            GridMenuItem(
                icon = CoreR.drawable.download,
                title = CoreR.string.action_download,
                onClick = onDownload
            )
        }
    }
    ...
    item {
        Column(
            ...
            Box(
                ...
                content = {
                    Icon(
                        painterResource(CoreR.drawable.bedtime),
                        contentDescription = null,
