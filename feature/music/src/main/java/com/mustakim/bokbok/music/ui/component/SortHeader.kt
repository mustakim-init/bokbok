...
inline fun <reified T : Enum<T>> SortHeader(
    ...
    Row(
                        ...
                        Icon(
                            ...
                            painterResource(
                                if (sortType ==
                                    ...
                                    CoreR.drawable.radio_button_checked
                                } else {
                                    CoreR.drawable.radio_button_unchecked
                                },
                            ),
        ...
        if (showDescending == true) {
            ...
            if (allowDescending) {
                ResizableIconButton(
                    icon = if (sortDescending) CoreR.drawable.arrow_downward else CoreR.drawable.arrow_upward,
                    color = MaterialTheme.colorScheme.primary,
                    modifier =
                    Modifier
                        .size(32.dp)
