...
fun AddToPlaylistDialogOnline(
    ...
    if (isVisible) {
        ListDialog(
            ...
            item {
                ListItem(
                    title = stringResource(MusicR.string.create_playlist),
                    thumbnailContent = {
                        Image(
                            painter = painterResource(id = CoreR.drawable.playlist_add),
            ...
            item {
                ListItem(
                    ...
                    title = stringResource(MusicR.string.liked_songs),
                    thumbnailContent = {
                        Image(
                            painter = painterResource(id = CoreR.drawable.favorite), // The XML image
                            contentDescription = null,
            ...
            item {
                Text(
                    text = stringResource(CoreR.string.playlist_add_local_to_synced_note),
