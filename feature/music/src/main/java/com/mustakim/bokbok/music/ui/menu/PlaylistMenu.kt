...
fun PlaylistMenu(
    ...
    if (showDeletePlaylistDialog) {
        DefaultDialog(
            ...
            content = {
                Text(
                    text = stringResource(CoreR.string.delete_playlist_confirm, playlist.playlist.name),
                    style = MaterialTheme.typography.bodyLarge,
                    modifier = Modifier.padding(horizontal = 18.dp)
                )
            },
            ...
            MenuSurfaceSection(modifier = Modifier.padding(vertical = 6.dp)) {
                Column {
                    ...
                    if (editable && autoPlaylist != true) {
                        ...
                        ListItem(
                            headlineContent = { Text(text = stringResource(CoreR.string.edit)) },
                            leadingContent = {
                                Icon(
                    ...
                    if (autoPlaylist != true && downloadPlaylist != true) {
                        ...
                        ListItem(
                            headlineContent = { Text(text = stringResource(CoreR.string.manage_tags)) },
                            leadingContent = {
                                Icon(
