...
import com.mustakim.bokbok.music.extensions.toggleRepeatMode
import com.mustakim.bokbok.music.lyrics.LyricsHelper
import com.mustakim.bokbok.music.models.MediaMetadata
import com.mustakim.bokbok.music.ui.component.Lyrics
import com.mustakim.bokbok.music.ui.component.LyricsV2
import com.mustakim.bokbok.music.constants.UseLyricsV2Key
import com.mustakim.bokbok.ui.shared.LocalMenuState
import com.mustakim.bokbok.ui.shared.BigSeekBar
...
import com.mustakim.bokbok.music.constants.PlayerCustomImageUriKey
import com.mustakim.bokbok.music.constants.PlayerCustomBlurKey
import com.mustakim.bokbok.music.constants.PlayerCustomContrastKey
import com.mustakim.bokbok.music.constants.PlayerCustomBrightnessKey
            ...
            coroutineScope.launch(Dispatchers.IO) {
                try {
                    ...
                    val entryPoint = EntryPointAccessors.fromApplication(
                        ...
                        com.mustakim.bokbok.music.di.LyricsHelperEntryPoint::class.java
                    )
        ...
        if (playerBackground == PlayerBackgroundStyle.GRADIENT || playerBackground == PlayerBackgroundStyle.COLORING || playerBackground == PlayerBackgroundStyle.BLUR_GRADIENT || playerBackground == PlayerBackgroundStyle.GLOW || playerBackground == PlayerBackgroundStyle.GLOW_ANIMATED) {
            if (mediaMetadata.thumbnailUrl != null) {
                ...
                if (cachedColors != null) {
                    ...
                    val result = execResult?.drawable
                ...
                Column(
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            Icon(
                                painter = painterResource(CoreR.drawable.expand_more),
                        ...
                        Box(
                            ...
                            Icon(
                                painter = painterResource(CoreR.drawable.more_horiz),
                            ...
                            Row(
                                    ...
                                    Icon(
                                        painter = painterResource(
                                            when (repeatMode) {
                                                ...
                                                Player.REPEAT_MODE_ALL -> CoreR.drawable.repeat
                                                Player.REPEAT_MODE_ONE -> CoreR.drawable.repeat_one
                                ...
                                BokBokIconButton(
                                    ...
                                    if (isLoading) {
                                        ...
                                        Icon(
                                            painter = painterResource(
                                                if (isPlaying) CoreR.drawable.pause else CoreR.drawable.play
                                            ),
                                            contentDescription = if (isPlaying) "Pause" else stringResource(CoreR.string.play),
                                            tint = textBackgroundColor,
                                            modifier = Modifier.size(36.dp)
                                        )
                                    }
                                ...
                                BokBokIconButton(
                                    ...
                                    Icon(
                                        ...
                                        contentDescription = if (shuffleModeEnabled) stringResource(MusicR.string.shuffle) else stringResource(MusicR.string.shuffle),
