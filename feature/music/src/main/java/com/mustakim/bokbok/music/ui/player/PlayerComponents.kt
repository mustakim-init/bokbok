        ...
        PlayerDesignStyle.V3, PlayerDesignStyle.V5 -> {
            Row(
                ...
                Box(
                    ...
                    Icon(
                        painter = painterResource(
                            if (currentSongLiked) CoreR.drawable.favorite
                            else CoreR.drawable.favorite_border
                        ),
                        contentDescription = null,
    ...
    when (playerDesignStyle) {
                    ...
                    FilledIconButton(
                        ...
                        if (isLoading) {
                            ...
                            Icon(
                                painter = painterResource(
                                    when {
                                        playbackState == STATE_ENDED -> CoreR.drawable.replay
                                        isPlaying -> CoreR.drawable.pause
                                        else -> CoreR.drawable.play
                                    }
                                ),
                                contentDescription = null,
                                modifier = Modifier.size(42.dp)
        ...
        PlayerDesignStyle.V1, PlayerDesignStyle.V5 -> {
            Row(
                ...
                Box(modifier = Modifier.weight(1f)) {
                    ResizableIconButton(
                        icon = CoreR.drawable.skip_previous,
                        enabled = canSkipPrevious,
                        color = textBackgroundColor,
                        modifier =
                        Modifier
                        ...
                        Image(
                            ...
                            painterResource(
                                if (playbackState ==
                                    ...
                                    CoreR.drawable.replay
                                } else if (isPlaying) {
                                    CoreR.drawable.pause
                                } else {
                                    CoreR.drawable.play
                                },
                            ),
                ...
                Box(modifier = Modifier.weight(1f)) {
                    ResizableIconButton(
                        icon = if (currentSongLiked) CoreR.drawable.favorite else CoreR.drawable.favorite_border,
