...
import com.mustakim.bokbok.music.constants.StatPeriod
...
import com.mustakim.bokbok.ui.shared.ChoiceChipsRow
import com.mustakim.bokbok.music.ui.component.HideOnScrollFAB
import com.mustakim.bokbok.ui.shared.BokBokIconButton
import com.mustakim.bokbok.music.ui.component.LocalAlbumsGrid
import com.mustakim.bokbok.music.ui.component.LocalArtistsGrid
import com.mustakim.bokbok.ui.shared.LocalMenuState
import com.mustakim.bokbok.music.ui.component.LocalSongsGrid
...
import com.mustakim.bokbok.music.ui.component.ItemThumbnail
...
import com.mustakim.bokbok.music.viewmodels.StatsViewModel
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                title = { Text(stringResource(MusicR.string.stats)) },
                navigationIcon = {
                    BokBokIconButton(
                ...
                actions = {
                    BokBokIconButton(
                        ...
                        Icon(
                            painterResource(CoreR.drawable.calendar_today),
                            contentDescription = stringResource(CoreR.string.year_in_music),
                        )
                    }
                },
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            LazyColumn(
                            ...
                            OptionStats.CONTINUOUS -> {
                                listOf(
                                    ...
                                    StatPeriod.YEAR_1.ordinal to pluralStringResource(
                                        CoreR.plurals.n_year,
                                        1,
                                        1
                                    ),
                                    StatPeriod.ALL.ordinal to stringResource(CoreR.string.filter_all),
                                )
                            }
                        },
                        options =
                        listOf(
                            OptionStats.CONTINUOUS to stringResource(id = CoreR.string.continuous),
                            OptionStats.WEEKS to stringResource(CoreR.string.weeks),
                            OptionStats.MONTHS to stringResource(CoreR.string.months),
                            OptionStats.YEARS to stringResource(CoreR.string.years),
                        ),
                ...
                item(key = "mostPlayedSongsHeader") {
                    NavigationTitle(
                        title = "${mostPlayedSongsStats.size} ${stringResource(id = MusicR.string.songs)}",
                ...
                item(key = "mostPlayedArtists") {
                    NavigationTitle(
                        title = "${mostPlayedArtists.size} ${stringResource(id = MusicR.string.artists)}",
                        modifier = Modifier.animateItem(),
                    )
                }
                ...
                item(key = "mostPlayedAlbums") {
                    NavigationTitle(
                        title = "${mostPlayedAlbums.size} ${stringResource(id = MusicR.string.albums)}",
                        modifier = Modifier.animateItem(),
                    )
            ...
            if (mostPlayedSongs.isNotEmpty()) {
                HideOnScrollFAB(
                    ...
                    onClick = {
                        playerConnection.playQueue(
                            ListQueue(
                                title = context.getString(CoreR.string.most_played_songs),
