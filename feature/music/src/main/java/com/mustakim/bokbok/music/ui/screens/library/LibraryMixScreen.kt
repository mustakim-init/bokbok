...
import com.mustakim.bokbok.music.constants.CONTENT_TYPE_PLAYLIST
...
import com.mustakim.bokbok.music.constants.MixSortDescendingKey
import com.mustakim.bokbok.music.constants.MixSortType
import com.mustakim.bokbok.music.constants.MixSortTypeKey
import com.mustakim.bokbok.music.constants.PlaylistSortType
import com.mustakim.bokbok.music.constants.PlaylistSortTypeKey
import com.mustakim.bokbok.music.constants.PlaylistTagsFilterKey
...
import com.mustakim.bokbok.music.constants.UseNewLibraryDesignKey
...
import com.mustakim.bokbok.music.db.entities.PlaylistEntity
import com.mustakim.bokbok.music.extensions.move
import com.mustakim.bokbok.music.extensions.reversed
import com.mustakim.bokbok.music.ui.component.AlbumGridItem
import com.mustakim.bokbok.music.ui.component.AlbumListItem
import com.mustakim.bokbok.music.ui.component.ArtistGridItem
import com.mustakim.bokbok.music.ui.component.ArtistListItem
import com.mustakim.bokbok.music.ui.component.LibraryPlaylistGridItem
import com.mustakim.bokbok.music.ui.component.LibraryPlaylistListItem
import com.mustakim.bokbok.ui.shared.LocalMenuState
import com.mustakim.bokbok.music.ui.component.PlaylistGridItem
import com.mustakim.bokbok.music.ui.component.PlaylistListItem
import com.mustakim.bokbok.music.ui.component.SortHeader
import com.mustakim.bokbok.music.ui.menu.AlbumMenu
import com.mustakim.bokbok.music.ui.menu.ArtistMenu
import com.mustakim.bokbok.music.ui.menu.PlaylistMenu
import com.mustakim.bokbok.data.local.rememberEnumPreference
import com.mustakim.bokbok.data.local.rememberPreference
import com.mustakim.bokbok.music.viewmodels.LibraryMixViewModel
...
fun LibraryMixScreen(
    ...
    val likedPlaylist =
        Playlist(
            playlist = PlaylistEntity(
                ...
                name = stringResource(MusicR.string.liked)
            ),
            songCount = 0,
    ...
    val downloadPlaylist =
        Playlist(
            playlist = PlaylistEntity(
                id = UUID.randomUUID().toString(),
                name = stringResource(MusicR.string.offline)
            ),
            songCount = 0,
            songThumbnails = emptyList(),
        )
    ...
    val topPlaylist =
        Playlist(
            playlist = PlaylistEntity(
                id = UUID.randomUUID().toString(),
                name = stringResource(MusicR.string.my_top) + " $topSize"
            ),
            songCount = 0,
            songThumbnails = emptyList(),
        )
    ...
    val cachePlaylist =
        Playlist(
            playlist = PlaylistEntity(
                id = UUID.randomUUID().toString(),
                name = stringResource(MusicR.string.cached_playlist)
            ),
            songCount = 0,
            songThumbnails = emptyList(),
        )
        ...
        Row(
            ...
            SortHeader(
                ...
                sortTypeText = { sortType ->
                    when (sortType) {
                        MixSortType.CREATE_DATE -> MusicR.string.sort_by_create_date
                        MixSortType.LAST_UPDATED -> MusicR.string.sort_by_last_updated
                        MixSortType.NAME -> MusicR.string.sort_by_name
                    }
                },
            )
            ...
            if (canEnterReorderMode) {
                BokBokIconButton(
                    ...
                    Icon(
                        painter = painterResource(if (reorderEnabled) CoreR.drawable.lock_open else CoreR.drawable.lock),
