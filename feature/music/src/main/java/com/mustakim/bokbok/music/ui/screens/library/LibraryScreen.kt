...
import com.mustakim.bokbok.music.ui.component.TagsFilterChips
...
fun LibraryScreen(
        ...
        Column {
            Row {
                ChipsRow(
                    chips =
                    listOf(
                        LibraryFilter.PLAYLISTS to stringResource(MusicR.string.filter_playlists),
                        LibraryFilter.SONGS to stringResource(MusicR.string.filter_songs),
                        LibraryFilter.ALBUMS to stringResource(MusicR.string.filter_albums),
                        LibraryFilter.ARTISTS to stringResource(MusicR.string.filter_artists),
                    ),
                    ...
                    icons = mapOf(
                        LibraryFilter.PLAYLISTS to CoreR.drawable.queue_music,
                        LibraryFilter.SONGS to CoreR.drawable.music_note,
                        LibraryFilter.ALBUMS to CoreR.drawable.album,
                        LibraryFilter.ARTISTS to CoreR.drawable.person,
                    ),
    ...
    Box(
        ...
        when (filterType) {
            LibraryFilter.LIBRARY -> LibraryMixScreen(navController, filterContent, scrollBehavior)
