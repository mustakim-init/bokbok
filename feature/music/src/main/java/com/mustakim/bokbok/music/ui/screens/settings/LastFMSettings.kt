...
import com.mustakim.bokbok.music.constants.LastFMUsernameKey
...
fun LastFMSettings(
    ...
    if (showLoginDialog) {
        ...
        AlertDialog(
            ...
            title = { Text(stringResource(MusicR.string.login)) },
            text = {
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(MusicR.string.username)) },
                        singleLine = true,
                        enabled = !isLoggingIn,
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(MusicR.string.password)) },
                        singleLine = true,
                    ...
                    if (isLoggingIn) {
                        Row(
                            ...
                            Text(
                                text = stringResource(MusicR.string.logging_in),
            ...
            confirmButton = {
                TextButton(
                    ...
                    Text(stringResource(MusicR.string.login))
                }
            },
            dismissButton = {
                TextButton(
                    ...
                    Text(stringResource(MusicR.string.cancel))
                }
            }
        )
    }
    ...
    Column(
        ...
        PreferenceGroupTitle(
            title = stringResource(MusicR.string.account),
        )

        PreferenceEntry(
            title = {
                Text(
                    text = if (isLoggedIn) lastfmUsername else stringResource(MusicR.string.not_logged_in),
            ...
            trailingContent = {
                if (isLoggedIn) {
                    OutlinedButton(onClick = {
                        ...
                        Text(stringResource(MusicR.string.action_logout))
                    }
                } else {
                    OutlinedButton(onClick = {
                        showLoginDialog = true
                    }, shapes = ButtonDefaults.shapes()) {
                        Text(stringResource(MusicR.string.action_login))
                    }
                }
            },
        )
        ...
        PreferenceGroupTitle(
            title = stringResource(MusicR.string.options),
        )

        SwitchPreference(
            title = { Text(stringResource(MusicR.string.enable_scrobbling)) },
        ...
        SwitchPreference(
            title = { Text(stringResource(MusicR.string.lastfm_now_playing)) },
        ...
        PreferenceGroupTitle(
            title = stringResource(MusicR.string.scrobbling_configuration)
        )
        ...
        if (showMinTrackDurationDialog) {
            ...
            AlertDialog(
                ...
                title = { Text(stringResource(MusicR.string.scrobble_min_track_duration)) },
                text = {
                    Column(
        ...
        if (showScrobbleDelayPercentDialog) {
            ...
            AlertDialog(
                ...
                title = { Text(stringResource(MusicR.string.scrobble_delay_percent)) },
                text = {
                    Column(
                        horizontalAlignment = Alignment.CenterHorizontally,
                        modifier = Modifier.padding(16.dp)
        ...
        if (showScrobbleDelaySecondsDialog) {
            ...
            AlertDialog(
                ...
                title = { Text(stringResource(MusicR.string.scrobble_delay_minutes)) },
                text = {
                    Column(
                        horizontalAlignment = Alignment.CenterHorizontally,
                        modifier = Modifier.padding(16.dp)
