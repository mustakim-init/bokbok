...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: com.mustakim.bokbok.music.ui.component.LyricsGlassStyle? = null
    ): Bitmap = withContext(Dispatchers.Default) {
        val style = glassStyle ?: com.mustakim.bokbok.music.ui.component.LyricsGlassStyle.FrostedDark
        ...
        if (coverArtUrl != null) {
            try {
                ...
                coverArtBitmap = result.drawable?.toBitmap()
            } catch (_: Exception) {}
        }
    ...
    private fun AppLogo(
        ...
        val rawLogo = context.getDrawable(CoreR.drawable.small_icon)?.toBitmap(logoSize, logoSize)
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/BokBok")
            }
